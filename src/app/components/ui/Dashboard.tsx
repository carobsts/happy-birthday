  ...
  const tabs: ITabs[] = [
    {
      ...
      description:
        "En esta sección, tenés algunos mensajitos que tus seres queridos te dejaron para que nunca olvides lo mucho que te quieren.",
      Component: <Tab1 />,
      tab: "1",
    ...
    },
    {
      ...
      description:
        "En esta sección, vas a poder encontrar tu canción recomendada de los Jonas, para que nunca se pierda la manija.",
      Component: (
        <Suspense key={`${trackId}`} fallback={<div> Cargando ... </div>}>
          <Tab4 trackId={trackId} />
        </Suspense>
      ),
      tab: "4",
